# Harmony Portal — District Manager Standard Operating Procedure

## 1. Overview

The **Harmony Portal** is a web-based content management tool that controls what appears on your in-store Harmony displays. As a **District Manager**, you manage content for your assigned district and all stores within it.

### What You Can Do

- Edit content at the **District level** (applies to all stores in your district)
...
- Access Operator Level settings — only Operators and Admins can edit these
- Access the Admin panel or manage users
- Edit content for districts or stores outside your assigned district
...
The **Select Site** dropdown is your primary way to choose what you are editing. As a District Manager, your dropdown contains:

### Dropdown Options

| Option Format | What It Means | Where Changes Save |
|---------------|---------------|-------------------|
| `District: [YourDistrict]` | Your district-level settings | `districts/[YourDistrict]` in Firestore |
| `Store: [StoreID]` | An individual store in your district | `stores/[StoreID]` in Firestore |

### How to Select

1. Click the **Select Site** dropdown (shows `-- Select a Site --` by default).
2. Choose the level you want to edit:
   - Pick your **District** entry to set defaults for all stores in your district.
...
4. The title above the editor will update to show what you are editing (e.g., *"Editing district:YourDistrict"*).
...
|----------------|-------------------|-------------|
| `District: [YourDistrict]` | `districts/[YourDistrict]` | All stores in your district |
...
Company (General)        ← Set by Admins only
  └── Operator (Market)  ← Set by Operators — you cannot edit this
        └── District     ← YOU set this for your district
...
- **Operator Level** content overrides Company content for all stores in that operator group.
- **District Level** content (yours) overrides Operator content for all stores in your district.
...
2. Your Operator sets a group-level announcement: "Operator Group Special: Free Coffee Fridays"
3. You add a district-level announcement: "District Training Wednesday at 2 PM"
4. You add a store-level announcement for Store 1234: "Store 1234 Grand Re-opening!"

**Result:**
- Stores in other districts see company + operator announcements only.
- Stores in your district (except 1234) see company + operator + your district announcement.
- Store 1234 sees company + operator + district + its own store announcement.

### What This Means for You

- Content set at the **Company** and **Operator** levels will already be showing on your stores' displays. You do not need to re-enter it.
- When you set content at the **District** level, it supplements or overrides what was set above.
- When you set content at the **Store** level, it supplements or overrides everything for that one store.

---

## 12. Tips and Best Practices

1. **Start at the District level.** Set your default content at the District level first, then override only where needed at individual store level.
